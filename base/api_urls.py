...
from .api_views import get_students, get_lecturers, StudentLoginAPIView, LecturerLoginAPIView, student_home, permission_api, verification_api, MarkAttendance, generateCode_api, PermissionTable_api, update_permission_api, logoutUser, studentsTable
...
urlpatterns = [
    ...
    path('api/studentsTable/<int:user_id>/', studentsTable),
]
