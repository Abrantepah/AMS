...
import { ForgotPasswordPage, LoginPage, RegisterPage, UpdatePasswordPage } from "./components/pages/auth/components";
              ...
              >
                <Routes>
                  <Route
                    element={
                      <Authenticated
                        ...
                        fallback={<CatchAllNavigate to="/login/student" />}
                      >
                        <Layout>
                          <Outlet />
                        </Layout>
                  ...
                  >
                    ...
                    <Route path="/login/lecturer" element={<RegisterPage />} />
                    <Route
